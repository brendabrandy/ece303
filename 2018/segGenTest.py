...
c1.ACK(1)
print c1.headerlen
c1.Options('001110101111000111111111111111111111111111110111111100000000') #have to options then data, in that order. Can modify this later.
